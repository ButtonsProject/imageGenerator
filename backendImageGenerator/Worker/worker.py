...
def empty_triangles(params):
    ...
    color_types = {"orange": ['Images/orange_cross.png', '#FF7500'],
                   ...
                   "yellow": ['Images/light_orange_cross.png', '#FF7500']}
    color = params["color"]
    ...
    main_text = params["main"]
    TextFunctions.create_text(draw_result, (110, 110), title_text, '#000000', font)
    TextFunctions.create_text(draw_result, (110, 216), main_text, color_types[color][1], font)
    return result
...
def closed_triangle_mask(params):
    ...
    color_types = {"orange": ['Images/triangleGradOrange.png', '#FF7500', 'Images/smallOrangeTriangle.png'],
                   "yellow": ['Images/triangleGradOrange.png', '#FF7500', 'Images/smallOrangeTriangle.png'],
...
def typographia(params):
    ...
    mask = mask.rotate(15)
    background.paste(result, (0, 100), mask)
    return background
